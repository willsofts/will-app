...
export declare function getMultiLanguages(): any;
export declare function setMultiLanguages(values: any): void;
export declare function getDefaultLanguage(): any;
export declare function setDefaultLanguage(language: string): void;
export declare function getApiToken(): any;
export declare function getApiUrl(): any;
export declare function getBaseUrl(): any;
export declare function getCdnUrl(): any;
export declare function getImgUrl(): any;
export declare function getChatUrl(): any;
export declare function getBaseStorage(): any;
export declare function getDefaultRawParameters(): any;
...
export declare function isSecureStorage(): any;
export declare function getBaseCss(): any;
export declare function setBaseCss(value: string): void;
export declare function getTokenKey(): any;
